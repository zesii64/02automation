...
REM Date range: auto 3 weeks ~ end of current month
...
REM Log: append to generate_v2_7_package\reports\pipeline.log
REM ==============================================================
...
set LOG=D:\11automation\02automation\10-Collection_Inspection\10-Collection_Inspection\generate_v2_7_package\reports\pipeline.log
