...
def generate_report(excel_path):
    ...
    # [Versioning Check]: Force import from v3.9 modules
    try:
        from run_daily_report_v3_9 import (
        ...
        from run_cashloan_report_v3_9 import build_cashloan_html, read_sheet_maybe_chunked, read_sheet
    except ImportError as e:
        print(f"错误: 缺少 v3.9 依赖脚本 ({e})。")
        return
    ...
    out_path = reports_dir / f"CashLoan_Inspection_Report_{date_str}_v3_9.html"
