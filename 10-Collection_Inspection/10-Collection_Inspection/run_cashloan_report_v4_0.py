...
<head>
    ...
    <title>CashLoan Inspection Report {date_str} (v4.0)</title>
...
<body class="p-6 max-w-[1400px] mx-auto">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">CashLoan Inspection Report v4.0</h1>
    ...
    <!-- 1.7 Deep Dive (Heatmap & Breakdown) -->
    {html_amount_heatmap}
    {html_breakdown_section}
    
    <!-- 1.8 Time Series Data -->
    {html_time_breakdown}
