# -*- coding: utf-8 -*-
"""
全链路巡检脚本 (All-in-One Inspection Script) v4.12
Feature:
...
def generate_report(excel_path):
    ...
    try:
        from run_daily_report_v4_14 import (
        ...
        from run_cashloan_report_v4_14 import build_cashloan_html, read_sheet_maybe_chunked, read_sheet
    ...
    out_path = reports_dir / f"CashLoan_Inspection_Report_{date_str}_v4_14.html"
