...
def generate_report(excel_path):
    ...
    try:
        from run_daily_report_v4_1 import (
        ...
        from run_cashloan_report_v4_1 import build_cashloan_html, read_sheet_maybe_chunked, read_sheet
    except ImportError as e:
        print(f"错误: 缺少 v4.1 依赖脚本 ({e})。")
        return
    ...
    out_path = reports_dir / f"CashLoan_Inspection_Report_{date_str}_v4_1.html"
