# -*- coding: utf-8 -*-
"""
全链路巡检脚本 (All-in-One Inspection Script) v4.3
Feature:
- v4.3 (Restored): 基于 v4.4 验证代码还原，确保数据与 v4.2 一致。
...
def generate_report(excel_path):
    ...
    try:
        from run_daily_report_v4_3 import (
        ...
        from run_cashloan_report_v4_3 import build_cashloan_html, read_sheet_maybe_chunked, read_sheet
    except ImportError as e:
        print(f"错误: 缺少 v4.3 依赖脚本 ({e})。")
        return
    ...
    out_path = reports_dir / f"CashLoan_Inspection_Report_{date_str}_v4_3.html"
