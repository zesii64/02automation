...
def generate_report(excel_path):
    ...
    # [Versioning Check]: Force import from v3.3 modules
    try:
        ...
        from run_cashloan_report_v3_3 import build_cashloan_html, read_sheet_maybe_chunked, read_sheet
    except ImportError as e:
        print(f"错误: 缺少 v3.3 依赖脚本 ({e})。")
        return
