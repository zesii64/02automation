...
def generate_report(excel_path):
    ...
    # [Versioning Check]: Force import from v3.8 modules
    try:
        from run_daily_report_v3_8 import (
        ...
        from run_cashloan_report_v3_8 import build_cashloan_html, read_sheet_maybe_chunked, read_sheet
    except ImportError as e:
        print(f"错误: 缺少 v3.8 依赖脚本 ({e})。")
        return
    ...
    perf_data = compute_collection_performance(df_repay)
    ...
    out_path = reports_dir / f"CashLoan_Inspection_Report_{date_str}_v3_8.html"
